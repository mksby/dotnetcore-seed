...
namespace Web.Api
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MemoryDbContext>(options => options.UseInMemoryDatabase(databaseName: "MemoryTable"));
            ...
            {
                configuration.RootPath = "ClientApp/dist/project";
            });

            // Register the Swagger generator, defining 1 or more Swagger documents
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Rednetnorf API", Version = "v1" });
